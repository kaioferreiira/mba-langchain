...
partes_do_texto_sumarizado = spliter.create_documents([long_text])

# print all partes_do_texto_sumarizado
for part in partes_do_texto_sumarizado:
...
result = pipeline.invoke(partes_do_texto_sumarizado)
print(result)
